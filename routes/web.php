...
use App\Http\Controllers\Front\ZerodhaPostbackController;
use App\Services\KiteSessionManager;
use Illuminate\Foundation\Http\Middleware\VerifyCsrfToken;
use Illuminate\Support\Facades\Route;

Route::middleware('app.track')->group(function () {
    ...
    Route::post('/zerodha/postback', [ZerodhaPostbackController::class, 'handle'])
        ->withoutMiddleware([VerifyCsrfToken::class])
        ->name('zerodha.postback');
